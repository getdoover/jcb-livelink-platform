...
from .app_ui import JcbLivelinkPlatformUI
from .app_state import JcbLivelinkPlatformState

log = logging.getLogger()

class JcbLivelinkPlatformApplication(Application):
    config: JcbLivelinkPlatformConfig  # not necessary, but helps your IDE provide autocomplete!

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

        self.started: float = time.time()
        self.ui: JcbLivelinkPlatformUI = None
        self.state: JcbLivelinkPlatformState = None

    async def setup(self):
        self.ui = JcbLivelinkPlatformUI()
        self.state = JcbLivelinkPlatformState()
